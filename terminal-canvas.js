  ...
  function renderOriginWeb(id, body) {
    var OD = {
      scotland: {
        ...
        macro: {
          exportVal:  {lbl:'TOTAL EXPORTS',        val:'£4.4bn',   sub:'2024 — SWA data'},
          cagr:       {lbl:'5-YR EXPORT CAGR',     val:'+8.2%',    sub:'2019–2024'},
          bottles:    {lbl:'BOTTLES EXPORTED',     val:'1.8bn',    sub:'all grades annually'},
          avgBottle:  {lbl:'AVG EXPORT VALUE',     val:'£24.40',   sub:'per 70cl bottle'},
          smShare:    {lbl:'SINGLE MALT SHARE',    val:'30%',      sub:'by value of total'},
      ...
      usa: {
        ...
        macro: {
          exportVal:  {lbl:'TOTAL EXPORTS',        val:'£1.26bn',  sub:'American whiskey 2024'},
          cagr:       {lbl:'5-YR EXPORT CAGR',     val:'+12%',     sub:'2019–2024'},
          bottles:    {lbl:'BOTTLES EXPORTED',     val:'50m+',     sub:'annual volume'},
          avgBottle:  {lbl:'AVG EXPORT VALUE',     val:'£31',      sub:'per 70cl bottle'},
          smShare:    {lbl:'KENTUCKY SHARE',        val:'95%',      sub:'of all US bourbon'},
    ...
    var FLOWS = {
      scotland: {
        'USA': {
          hist:[{yr:2019,v:890},{yr:2020,v:520},{yr:2021,v:680},{yr:2022,v:950},{yr:2023,v:1050},{yr:2024,v:1100},{yr:2025,v:1020}],
          proj:[{yr:2026,v:1300}],
          cagr3:'+2.4%', cagr5:'+14.4%',
          cats:[{n:'Single Malt',p:42},{n:'Blended Scotch',p:38},{n:'Single Grain',p:12},{n:'Blended Malt',p:8}],
          ...
          note:'Largest export market for Scotch, now fully tariff-free for the first time since 2018. The 10% Trump tariff (Apr 2025–Jul 2026) cost the industry an estimated £200m before resolution. The July 2026 zero-for-zero deal is structurally bullish — exports to the US are expected to accelerate sharply into 2027.',
        },
        'France': {
          hist:[{yr:2019,v:480},{yr:2020,v:390},{yr:2021,v:430},{yr:2022,v:490},{yr:2023,v:515},{yr:2024,v:530},{yr:2025,v:542}],
          proj:[{yr:2026,v:558}],
          cagr3:'+3.4%', cagr5:'+6.8%',
          ...
          note:'France has historically been the largest EU destination for Scotch by volume, driven by blended categories. Single malt growth is gradual but consistent, supported by specialist whisky bars in Paris and Lyon.',
        },
        'Singapore': {
          hist:[{yr:2019,v:280},{yr:2020,v:200},{yr:2021,v:260},{yr:2022,v:320},{yr:2023,v:340},{yr:2024,v:355},{yr:2025,v:382}],
          proj:[{yr:2026,v:418}],
          cagr3:'+6.1%', cagr5:'+13.8%',
          ...
          note:'Singapore\'s import figures overstate direct consumption — an estimated 35–40% is re-exported across ASEAN. Its role as a transit and auction hub makes it a critical indicator of broader Asia-Pacific demand.',
        },
        'Germany': {
          hist:[{yr:2019,v:240},{yr:2020,v:195},{yr:2021,v:220},{yr:2022,v:255},{yr:2023,v:260},{yr:2024,v:265},{yr:2025,v:271}],
          proj:[{yr:2026,v:280}],
          cagr3:'+2.0%', cagr5:'+6.8%',
          ...
          note:'Germany\'s whisky market is one of Europe\'s most developed, with a strong independent retailer network and an enthusiastic collector base. Growth is steady rather than rapid.',
        },
        'India': {
          hist:[{yr:2019,v:110},{yr:2020,v:80},{yr:2021,v:105},{yr:2022,v:155},{yr:2023,v:195},{yr:2024,v:220},{yr:2025,v:248}],
          proj:[{yr:2026,v:340}],
          cagr3:'+16.9%', cagr5:'+25.3%',
          ...
          note:'The UK-India FTA (July 2026) is the most significant structural event for Scotch exports in a generation. India\'s tariff falling from 150% to 75% makes Scotch meaningfully more accessible to India\'s 400m+ strong middle class. The SWA forecasts £1bn in additional exports over 5 years, with further upside as the rate drops to 40% by 2036. This is now the highest-growth frontier market for Scotch.',
        },
        'Taiwan': {
          hist:[{yr:2019,v:130},{yr:2020,v:120},{yr:2021,v:145},{yr:2022,v:160},{yr:2023,v:170},{yr:2024,v:175},{yr:2025,v:183}],
          proj:[{yr:2026,v:194}],
          cagr3:'+4.6%', cagr5:'+8.8%',
          ...
          note:'Taiwan punches well above its weight for single malt consumption per capita. The collector market is mature and discerning, with Kavalan\'s domestic success driving broader whisky education and interest in aged Scotch expression.',
        },
        'UAE': {
          hist:[{yr:2019,v:100},{yr:2020,v:70},{yr:2021,v:95},{yr:2022,v:115},{yr:2023,v:125},{yr:2024,v:130},{yr:2025,v:141}],
          proj:[{yr:2026,v:154}],
          cagr3:'+7.0%', cagr5:'+15.0%',
          cats:[{n:'Single Malt',p:44},{n:'Ultra Premium',p:28},{n:'Blended Scotch',p:20},{n:'Other',p:8}],
      ...
      japan: {
        'USA': {
          hist:[{yr:2019,v:70},{yr:2020,v:55},{yr:2021,v:95},{yr:2022,v:135},{yr:2023,v:168},{yr:2024,v:180},{yr:2025,v:208}],
          proj:[{yr:2026,v:242}],
          cagr3:'+15.5%', cagr5:'+30.5%',
          cats:[{n:'Single Malt',p:60},{n:'Blended',p:25},{n:'Grain',p:15}],
          ...
          note:'The US is now the fastest-growing export destination for Japanese whisky. Supply constraints — particularly for 12yr+ expressions — mean value growth is significantly outpacing volume. The shortage dynamic is accelerating secondary market premiums.',
        },
        'France': {
          hist:[{yr:2019,v:30},{yr:2020,v:25},{yr:2021,v:38},{yr:2022,v:62},{yr:2023,v:82},{yr:2024,v:93},{yr:2025,v:106}],
          proj:[{yr:2026,v:120}],
          cagr3:'+19.6%', cagr5:'+33.5%',
          cats:[{n:'Single Malt',p:55},{n:'Blended',p:30},{n:'Grain',p:15}],
          ...
          note:'France has become the EU\'s most dynamic Japanese whisky market, growing at nearly 35% per year over three years. The cultural affinity between French gastronomy and Japanese craft is a genuine commercial driver.',
        },
        'Singapore': {
          hist:[{yr:2019,v:22},{yr:2020,v:18},{yr:2021,v:30},{yr:2022,v:52},{yr:2023,v:65},{yr:2024,v:72},{yr:2025,v:84}],
          proj:[{yr:2026,v:98}],
          cagr3:'+17.4%', cagr5:'+36.2%',
          ...
          note:'Singapore acts as the APAC distribution and auction hub for Japanese whisky. Values here indicate broad regional demand, not just domestic consumption. The ultra-rare segment (Chichibu, limited Yamazaki) is disproportionately routed through Singapore.',
        },
        'China': {
          hist:[{yr:2019,v:12},{yr:2020,v:10},{yr:2021,v:16},{yr:2022,v:20},{yr:2023,v:26},{yr:2024,v:31},{yr:2025,v:38}],
          proj:[{yr:2026,v:50}],
          cagr3:'+23.9%', cagr5:'+30.5%',
          ...
          note:'China is the highest-growth frontier for Japanese whisky but carries geopolitical risk. The 10% tariff is manageable; the diplomatic relationship is the key risk factor. Suntory has made significant direct investment in China distribution infrastructure.',
        },
        'Germany': {
          hist:[{yr:2019,v:14},{yr:2020,v:11},{yr:2021,v:17},{yr:2022,v:26},{yr:2023,v:38},{yr:2024,v:51},{yr:2025,v:58}],
          proj:[{yr:2026,v:70}],
          cagr3:'+30.7%', cagr5:'+39.4%',
          ...
          note:"Germany is Japan's largest EU market outside France and has grown at over 30% per year since the EU–Japan EPA took effect. The German specialist whisky retail network is one of Europe's most developed — driving collector demand for limited Yamazaki and Nikka expressions.",
        },
        'Australia': {
          hist:[{yr:2019,v:10},{yr:2020,v:11},{yr:2021,v:14},{yr:2022,v:24},{yr:2023,v:34},{yr:2024,v:46},{yr:2025,v:53}],
          proj:[{yr:2026,v:62}],
          cagr3:'+30.2%', cagr5:'+37.0%',
          cats:[{n:'Single Malt',p:62},{n:'Blended',p:24},{n:'Grain',p:14}],
          ...
          note:"Australia has developed into a significant Japanese whisky market, helped by cultural ties and the JAEPA eliminating spirits tariffs by 2022. Langton's auction house increasingly catalogues Japanese lots. Growth is accelerating as supply-constrained Japanese expressions command premiums across APAC.",
        },
        'UK': {
          hist:[{yr:2019,v:18},{yr:2020,v:15},{yr:2021,v:22},{yr:2022,v:32},{yr:2023,v:38},{yr:2024,v:41},{yr:2025,v:47}],
          proj:[{yr:2026,v:55}],
          cagr3:'+13.7%', cagr5:'+25.6%',
          cats:[{n:'Single Malt',p:65},{n:'Blended Premium',p:22},{n:'Grain',p:13}],
          ...
          note:"The UK is Japan's most mature Western export market, anchored by The Whisky Exchange and a deep specialist retail and auction ecosystem. While growth is slower than frontier markets, the UK generates the highest average bottle values outside Japan for premium expressions.",
        },
      },
      usa: {
        'EU': {
          hist:[{yr:2019,v:400},{yr:2020,v:160},{yr:2021,v:200},{yr:2022,v:280},{yr:2023,v:320},{yr:2024,v:340},{yr:2025,v:375}],
          proj:[{yr:2026,v:412}],
          cagr3:'+10.3%', cagr5:'+18.5%',
          ...
          note:'The EU retaliatory tariff (2018–2021) cost American whiskey an estimated £900m in lost European revenue. The recovery since suspension has been strong but the market has not fully recovered to trend. A permanent resolution to the metals dispute would unlock sustained growth.',
        },
        'UK': {
          hist:[{yr:2019,v:185},{yr:2020,v:140},{yr:2021,v:175},{yr:2022,v:210},{yr:2023,v:220},{yr:2024,v:226},{yr:2025,v:236}],
          proj:[{yr:2026,v:258}],
          cagr3:'+4.0%', cagr5:'+11.0%',
          ...
          note:'The UK is American whiskey\'s most established international market outside North America. Post-Brexit, the UK independently set spirits import duties to zero, making it one of the most accessible markets in the world for US producers.',
        },
        'Japan': {
          hist:[{yr:2019,v:60},{yr:2020,v:55},{yr:2021,v:68},{yr:2022,v:78},{yr:2023,v:84},{yr:2024,v:88},{yr:2025,v:94}],
          proj:[{yr:2026,v:102}],
          cagr3:'+6.4%', cagr5:'+11.4%',
          ...
          note:'Japan is a sophisticated and growing market for American whiskey, particularly bourbon. The highball format — standard in Japanese bars — has driven volume adoption of lighter bourbon expressions alongside the existing premium collector market.',
        },
        'Australia': {
          hist:[{yr:2019,v:85},{yr:2020,v:72},{yr:2021,v:88},{yr:2022,v:102},{yr:2023,v:114},{yr:2024,v:125},{yr:2025,v:132}],
          proj:[{yr:2026,v:142}],
          cagr3:'+9.0%', cagr5:'+12.8%',
          ...
          note:"Australia is the third-largest international market for American whiskey. Bourbon is a staple in Australian bars — second only to Scotch in premium spirits market share. The 5% tariff is a minor friction. Despite no bilateral FTA, the category grows consistently at high single-digit rates.",
        },
        'Canada': {
          hist:[{yr:2019,v:82},{yr:2020,v:70},{yr:2021,v:80},{yr:2022,v:90},{yr:2023,v:96},{yr:2024,v:100},{yr:2025,v:108}],
          proj:[{yr:2026,v:118}],
          cagr3:'+6.3%', cagr5:'+9.1%',
          ...
          note:"Canada is American whiskey's most natural export market. USMCA guarantees frictionless zero-tariff access. When Canada threatened retaliatory tariffs in 2025, spirits were deliberately excluded — signalling political sensitivity about disrupting this deeply integrated cross-border trade.",
        },
        'Singapore': {
    ...
    function buildDrillDown() {
      ...
      var chartLbl = 'IMPORT VALUE — INDUSTRY ESTIMATES 2019–2025 · 2026 PROJECTED';

...
- "Once you've seen the performance data, you'll understand why clients stay with this for years."
...
- "You have spent years building this capital. You know how volatile public markets have become. And you understand that inflation doesn't wait for a convenient moment. Which is exactly why moving a portion into a non-correlated structure makes complete sense right now."
- "Interest rates have shifted. Your cash position is losing real value every month. And you already know that the clients who act in this environment are the ones who look back at it as an opportunity. So let's look at how to position that capital today."
...
exports.handler = async (event) => {
  ...
  if (event.httpMethod === 'POST') {
    ...
    try {
      ...
      /* Pitch-playbook uses condensed PITCH_SYSTEM; factual sections use CONCEPT_SYSTEM */
